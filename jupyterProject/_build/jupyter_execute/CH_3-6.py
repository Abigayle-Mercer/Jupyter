...
This graph is a representation of the infection rate as a percent of the total population of Cook County. For objective comparison, all the derivitives are normalized by population.  
Remember, Cook's estimated infections first increased exponentially and then followed a logarithmic curve. It's first derivitive follows an overall positive slope and then negative: as I would expect. As the infection rate approaches zero, Cook county's total infections will eventually cap.

plot_second_derivitive(deaths_df_CK, two, 5150233)

As indicated by case rate, the second derivitive, or change in infection rate, hovers above zero in the red shaded region. And just as the total infection graph turned over, the rate of infection rate trends toward the blue highlighted region. You can see that there is a 'blip' in the graph around the beggining of May. If this graph were a perfect representation of a population's infection rate without any human intervention, there would be a perfect smooth curve up into the red and then below into the blue. This blip is indicative of an infection spike. A spike could be caused by a group of buisinesses opening up, a protest rally, or change in policy. Looking at how the dates of pontentially important events affect infection rates accross counties will be investigated in the next chapter.
...
This graph displays only a slight fluctuation in case rate, generally only affecting .1% of the population each day. Such consistency suggests the virus is spreading at a general linear rate. 

plot_second_derivitive(deaths_df_LA, two, 10039107)

This graph confirms the constant case rate, as it dips above and below the zero line multiple times. A function will only have a second derivitive of zero if it progresses linearly. In the case of viral infections, this can mean either there are no new infections, hence a linear rate of zero, or infections are rising at a linear rate with no sign of speeding up or slowing down. Because we can look at the original graph of total infection estimates, as displayed in chapter 3-2, it is clear that LA county has not turned over and infections continue to rise. 
...
Miami-Dade's infection rate appears to have no significant increase or decrease, rising slightly above zero. Absent of any major fluctuations, this graph suggests the virus is spreading a slow, but steady linear rate. 
...
Maricopa appears to have a consistent rate at about 0.01%of the population being infectd per day. In the last few weeks, however, there is a significant increase. Maricopa county lifted their stay at home order on May 15th, which may explain the rising case rates. The graph begins it's climb about 2 weeks after May 15th, which checks out with the the virus's 2 week average incubation period, and 18 day time until death. 
